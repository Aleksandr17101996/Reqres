...
class TestRequests:
    class TestMain:
        ...
        def test_get_delayed_response(self, driver):
            """Проверяем что при нажатии на отправку get запроса c задеркой ответа в 3 секунды
               возвращается статус кода 200, в теле ответа содержится информация о пользователях"""
